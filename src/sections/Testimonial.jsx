...
const ReviewCard = ({
  ...
  return (
    <figure
      className={twMerge(
        "relative h-full w-fit sm:w-36 cursor-pointer overflow-hidden rounded-xl border p-4  border-gray-50/[.1]  bg-gradient-to-r bg-indigo to-storm hover:bg-royal hover-animation"
      )}
    >
...
export default function Testimonial() {
  return (
    ...
    <div className="relative flex h-[500px] w-full flex-col justify-center overflow-hidden">
